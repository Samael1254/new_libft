...
/*   Updated: 2024/12/12 18:34:55 by gfulconi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		t_vector3D cam_rot, t_ivector2D display_size)
{
	...
	proj.x = ((double)display_size.x / 2) * v.x + ((double)display_size.x / 2)
		* v.z;
	proj.y = ((double)display_size.x / 2) * v.y + ((double)display_size.y / 2)
		* v.z;
	proj.z = 1;
	return (proj);
}
